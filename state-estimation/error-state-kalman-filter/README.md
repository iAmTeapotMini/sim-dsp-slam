...
* $n_{k-1} \sim \mathcal{N}\left(0, \Delta t \begin{bmatrix} \sigma^2_{acc}I & 0 \\ 0 & \sigma^2_{gyro}I \end{bmatrix}\right)$ — вектор белого шума акселерометра и гироскопа.
...
Алгоритм осуществляет чтение и разбор комплексного бинарного лога симуляции из файла `data/data.pkl`. В файле содержатся:
